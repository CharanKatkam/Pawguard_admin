        ...
        <div className="soft-card" style={{ padding: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", flexWrap: "wrap", gap: "10px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
              <div style={{ position: "relative", minWidth: "240px" }}>
                ...
                <input
                  type="text"
                  placeholder="Search family, email, preferences..."
                  value={searchQuery}
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "16px", paddingTop: "12px", borderTop: "1px solid #E2E8F0" }}>
            <span style={{ fontSize: "13px", color: "#64748B" }}>
              Showing {filteredFosters.length > 0 ? (page - 1) * pageSize + 1 : 0} to {Math.min(page * pageSize, filteredFosters.length)} of {filteredFosters.length} profiles
            </span>
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              <button
                disabled={page * pageSize >= filteredFosters.length}
                onClick={() => setPage((p) => p + 1)}
                style={{ padding: "6px 14px", borderRadius: "6px", border: "1px solid #CBD5E1", background: page * pageSize >= filteredFosters.length ? "#F1F5F9" : "#FFF", cursor: page * pageSize >= filteredFosters.length ? "not-allowed" : "pointer" }}
              >
                Next
              </button>
            </div>
